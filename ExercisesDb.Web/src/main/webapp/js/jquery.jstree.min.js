    ...
    $(function() {
        ...
        var u = navigator.userAgent.toLowerCase(),
            ...
            css_string = '' +
                ...
                '.jstree li { display:block; min-height:24px; line-height:24px; white-space:nowrap; margin-left:18px; } ' +
                '.jstree > ul > li { margin-left:0px; } ' +
                '.jstree ins { display:inline-block; text-decoration:none; width:18px; height:18px; margin:0 0 0 0; padding:0; } ' +
                '#main #leftdiv .jstree a {font-size:14px; display:inline-block; line-height:16px; height:16px; color:#333; white-space:nowrap; text-decoration:none; margin:0; } ' +
                '.jstree a {font-size: 14px;display: inline-block;line-height: 16px;height: 16px;color: #333;white-space: nowrap;text-decoration: none;margin: 0px;}'+
    ...
    $.jstree.plugin("core", {
        ...
        _fn: {
            init: function() {
                var $jstree = this;
                this.set_focus();
                this.get_container().html("<ul><li class='jstree-last jstree-leaf'><ins>&#160;</ins><a class='jstree-loading' href='#'><ins class='jstree-icon'>&#160;</ins>加载中 ...</a></li></ul>");
    ...
    $.jstree.plugin("ui", {
        __init: function() {
            ...
            this.get_container()
                ...
                //                //单击方法
                //                .bind("a", "click.jstree", $.proxy(function (event) {
                //                    event.preventDefault();
                //                    this.select_node(event.currentTarget, true, event);
                //                }, this))
                //                //双击方法
                //                .bind("a", "dblclick.jstree", $.proxy(function(event) {
                //                    event.preventDefault();
                    ...
                    h2 = obj.css("position", "relative").append(
                        $("<input>", {
                            ...
                            "css": {
                                ...
                                "left": (w1 + w2 + 4) + "px",
                                "top": "0px",
                                "height": (this.data.core.li_height) + "px",
                                "lineHeight": (this.data.core.li_height) + "px",
                                "padding":"1px 0",
                                "fontSize":"12px",
    ...
    $.jstree.plugin("dnd", {
        ...
        _fn: {
            dnd_prepare: function() {
                try{r.offset();}catch(e){return false;}
            ...
            start_drag: function(obj, e) {
                ...
                $.vakata.dnd.drag_start(e, { jstree: true, obj: o }, "<ins class='jstree-icon'></ins>" + (o.length > 1 ? "多个目录" : this.get_text(o)));
                if (this.data.themes) {
                    m.attr("class", "jstree-" + this.data.themes.theme);
                    $.vakata.dnd.helper.attr("class", "jstree-dnd-helper jstree-" + this.data.themes.theme);
                }
        ...
        _fn: {
            ...
            change_state: function(obj, state) {
                ...
                if (state) { obj.find("li").andSelf().removeClass("jstree-checked jstree-undetermined").addClass("jstree-unchecked"); }
                    ...
                    if(!obj) return;
                    obj.find("li").andSelf().removeClass("jstree-unchecked jstree-undetermined").addClass("jstree-checked"); this.data.ui.last_selected = obj;
                }
...
(function($) {
    $.vakata.context = {
        ...
        parse: function(s, is_callback) {
            ...
            $.each(s, function(i, val) {
                ...
                if (val.submenu) {
                    str += "<span style='position:absolute;left:85px;top:0;'>&raquo;</span>";
                }
                str += "</a>";
                if (val.submenu) {
    ...
    $(function() {
        var css_string = '' +
            '#vakata-contextmenu { display:none; position:absolute; margin:0; padding:0; width:100px; background:#ebebeb; border:1px solid silver; } ' + //原先180px
            '#vakata-contextmenu ul { width:100px; } ' + //min-width:180px
            '#vakata-contextmenu ul, #vakata-contextmenu li { margin:0; padding:0; list-style-type:none; display:block; } ' +
            '#vakata-contextmenu li { line-height:20px; height:20px; position:relative; padding:0px; } ' +
        ...
        defaults: {
            ...
            items: { // Could be a function that should return an object like this one
                ...
                "ccp": {
                    ...
                    "separator_after": false,
                    "label": "更多",
                    //"action": function(obj) { return;//this.remove(obj) }, ;
                    "submenu": {
                        "cut": {
                            "separator_before": false,
                            "separator_after": false,
